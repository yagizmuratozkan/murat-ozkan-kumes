...
def hesapla_su_hazirlik(gunluk_su_tuketimi):
    ...
    # Minimum 400L, maksimum 1000L
    su_hazirlik = max(400, min(gunluk_su_tuketimi, 1000))
    
    # 6 saatlik blok
    blok_6saat = su_hazirlik / 4
    
    # Eğer 6 saatlik blok 400L'den azsa, 12 saatlik blok yap
    if blok_6saat < 400:
